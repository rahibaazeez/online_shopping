...
if(isset($_POST['submit'])){
    ...
    $place=$_POST['place'];
    $sql=mysqli_query($conn,"INSERT INTO user_reg(name,mobile,email,password,place) VALUES('$name','$mobile','$email','$password','$place')");
    $value=mysqli_insert_id($conn);
    $sql1=mysqli_query($conn,"INSERT INTO online_login(login_id,username,password,type) VALUES('$value','$email','$password','buyer')");
    if($sql1)
    {
