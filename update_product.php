...
$id=$_GET['id'];
$sql=mysqli_query($conn,"SELECT * FROM products WHERE p_id='$id'");
...
if(isset($_POST['submit'])){
    ...
    $sql1=mysqli_query($conn,"UPDATE products SET p_name='$name',p_price='$price',p_brand='$brand',p_image='$image' WHERE p_id='$id'");
    if($sql1)
    {
        echo '<script> alert("updated sucessfully");window.location.href="view_product.php";</script>';
    }
    else{
